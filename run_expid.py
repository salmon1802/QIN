...
if __name__ == '__main__':
    ...
    parser.add_argument('--expid', type=str, default='QIN_variety_v9_with_level_feature', help='The experiment id to run.')
    ...
    model.fit(train_gen, validation_data=valid_gen, test_gen=test_gen, **params)
