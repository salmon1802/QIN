...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', type=str, default='./config/QIN_tuner_config.yaml',
    ...
    parser.add_argument('--gpu', nargs='+', default=[0, 1, 2, 3, 3, 2, 1, 0], help='The list of gpu indexes, -1 for cpu.')
