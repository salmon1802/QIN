...
class QIN_variety_v12(BaseModel):
    def __init__(self,
                 feature_map,
                 model_id="QIN_variety_v12",
                 gpu=-1,
                 num_layers1=3,
                 num_row1=2,
                 num_layers2=3,
                 ...
                 **kwargs):
        super(QIN_variety_v12, self).__init__(feature_map,
                                             model_id=model_id,
                                             gpu=gpu,
        ...
        self.qnn1 = QuadraticNeuralNetworks(input_dim=input_dim,
                                           num_layers=num_layers1,
                                           net_dropout=net_dropout,
                                           num_row=num_row1,
                                           batch_norm=batch_norm)
        self.qnn2 = QuadraticNeuralNetworks(input_dim=input_dim,
    ...
    def forward(self, inputs):
        ...
        y_pred1 = self.qnn1(feature_emb)
        y_pred2 = self.qnn2(feature_emb)
    ...
    def add_loss(self, return_dict, y_true):
        ...
        loss1 = self.loss_fn(y_pred1, return_dict["y_pred"].detach(), reduction='mean')
        loss2 = self.loss_fn(y_pred2, return_dict["y_pred"].detach(), reduction='mean')
